...
export class ComputerItem extends Interactable implements Examine {
    ...
    public examine(): ActionResult | undefined {
        return new TextActionResult(["Your trusty old computer is powered on", "You haven't caught up with your e-mails yet", "Maybe you can use it for some detective work"]);
    }
    ...
    public solve(choiceId?: number | undefined): ActionResult | undefined {
        ...
        switch(choiceId) {
            ...
            case 3:
                return new TextActionResult(["Dear Seeker,", "Within the whispers of nature lies a clue: 'Where breezes end, liquid beginnings follow.'", "Seek this juncture, where elements intertwine.", "Answers emerge where transitions blur.", "Unravel the enigma that awaits."],);
            case 4:
        ...
        return new SolveActionResult(this, ["You log in to your computer", "What will you do?"], [
