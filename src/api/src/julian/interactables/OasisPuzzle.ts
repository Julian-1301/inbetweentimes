    ...
    public solve(choiceId?: number | undefined): ActionResult | undefined {
        ...
        switch (choiceId) {
            ...
            case 4:
                ...
                return new TextActionResult(["That seemed to work,", "You hear the sound of a chest opening next to you.", "There is a <blue>Button</blue> inside of it.", "Maybe you should pick it up."]);
            case 7:
                return new SolveActionResult(this, ["Which button do you press Second?"], 
                    [
                    new SolveChoiceAction(8, "Earth"),
